...
export type MhdAccommodationCaseRecordTab = 'detail' | 'messages' | 'correspondence';
...
export function MhdAccommodationCaseRecordTabs({
  ...
  const tabs: Array<{ key: MhdAccommodationCaseRecordTab; label: string; to: string }> = [
    ...
    { key: 'messages', label: 'Messages', to: `/accommodations/${caseId}/messages` },
    { key: 'correspondence', label: 'Correspondence', to: `/accommodations/${caseId}/correspondence` },
  ];
