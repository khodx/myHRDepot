...
export function MhdTopBar({ onOpenNav }: { onOpenNav?: () => void }) {
  ...
  return (
    <>
      <header className="flex h-[72px] shrink-0 items-center justify-between gap-4 bg-card px-4 lg:px-6">
        <div className="flex min-w-0 flex-1 items-center gap-3 overflow-x-auto">
          ...
          {mhdCanAccessRoute('/communications', roles) ? (
            ...
            >
              <MessageSquarePlus
                className="mhd-topbar-icon-glyph h-[39.6px] w-[39.6px]"
                aria-hidden
              />
              <span aria-hidden className="text-sm font-medium leading-none whitespace-nowrap">
                Communications
      ...
      <div aria-hidden className="h-1 bg-accent/60" style={{ marginTop: '5px' }} />
    </>
  );
}
