  ...
  return (
    <div className="relative">
      <button
        ...
        className="mhd-topbar-icon-btn relative inline-flex flex-col items-center justify-center gap-0.5 rounded-lg p-1.5 text-muted-foreground transition-colors"
      >
        <Bell className="mhd-topbar-icon-glyph h-[39.6px] w-[39.6px]" />
        <span aria-hidden className="text-sm font-medium leading-none whitespace-nowrap">Alerts</span>
        <MhdCountBadge
          count={unreadCount}
