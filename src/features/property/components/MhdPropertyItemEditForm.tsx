    ...
    <form className="space-y-4 rounded-xl border border-border bg-card p-6 shadow-sm" onSubmit={handleSubmit(onSubmit)}>
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">The live update RPC supports name, description, status, and condition notes.</p>
        </div>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <div>
          ...
          <select className="w-full rounded-md border border-border px-3 py-2 text-sm" {...register('status')}>
        ...
        <div>
          ...
          <input className="w-full rounded-md border border-border px-3 py-2 text-sm" {...register('conditionNotes')} />
