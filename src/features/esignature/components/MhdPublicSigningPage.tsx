...
export function MhdPublicSigningPage() {
  ...
  if (isLoading) {
    return <div className="flex min-h-screen items-center justify-center text-sm text-slate-500">Loading signing ceremony...</div>;
  }
        ...
        <div className="mx-auto max-w-3xl rounded-3xl border border-rose-200 bg-white p-8 shadow-sm">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="mt-3 text-sm leading-6 text-slate-600">{loadError ?? 'The signing request could not be loaded.'}</p>
            </div>
          </div>
        </div>
      </main>
    ...
    <main className="min-h-screen bg-slate-50 px-6 py-10">
      <div className="mx-auto max-w-7xl space-y-6">
            ...
            {terminal ? (
              ...
              <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold uppercase tracking-[0.22em] text-sky-700">Step 1 of 2</p>
                    <h2 className="mt-2 text-2xl font-bold text-slate-900">Consent to electronic records</h2>
                    <p className="mt-3 text-sm leading-6 text-slate-600">
                ...
                <div className="mt-6 rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  <p className="text-xs font-semibold uppercase tracking-[0.22em] text-slate-500">Disclosure text</p>
                ...
                <button
                  ...
                  className="mt-6 inline-flex rounded-md bg-sky-700 px-4 py-2 text-sm font-semibold text-white disabled:cursor-not-allowed disabled:bg-slate-400"
                >
              ...
              <div className="space-y-6">
                <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm font-semibold uppercase tracking-[0.22em] text-sky-700">Step 2 of 2</p>
                      <h2 className="mt-2 text-2xl font-bold text-slate-900">Type your signature and confirm intent</h2>
                      <p className="mt-3 text-sm leading-6 text-slate-600">
        ...
        <div className="text-center text-xs text-slate-500">
          ...
          <div className="mt-2">
            <Link to="/login" className="font-semibold text-sky-700 hover:underline">Platform sign-in</Link>
          </div>
        </div>
      </div>
    </main>
