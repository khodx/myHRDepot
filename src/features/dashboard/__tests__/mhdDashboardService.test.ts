  ...
  describe('getModuleAlerts', () => {
    it('maps RPC row to typed alert counts', async () => {
        ...
        data: [
          {
            ...
            activities_needs_attention: '2',
            esignature_needs_attention: '1',
            attendance_needs_attention: '4',
            accommodations_needs_attention: '1',
            training_needs_attention: '5',
            my_training_needs_attention: '2',
            handbooks_needs_attention: '6',
            my_handbooks_needs_attention: '1',
            conduct_needs_attention: '2',
            investigations_needs_attention: '1',
            communications_needs_attention: '7',
          },
        ],
        error: null,
      });
      ...
      expect(result).toEqual({
        ...
        activitiesNeedsAttention: 2,
        esignatureNeedsAttention: 1,
        attendanceNeedsAttention: 4,
        accommodationsNeedsAttention: 1,
        trainingNeedsAttention: 5,
        myTrainingNeedsAttention: 2,
        handbooksNeedsAttention: 6,
        myHandbooksNeedsAttention: 1,
        conductNeedsAttention: 2,
        investigationsNeedsAttention: 1,
        communicationsNeedsAttention: 7,
      });
    });
