  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 p-4">
      <div className="w-full max-w-md rounded-xl border border-border bg-card p-6 shadow-sm">
        <h2 className="text-base font-semibold text-foreground">Adjust points</h2>
        ...
        <div className="mt-4 space-y-3">
          <div>
            <label htmlFor="adjust-delta" className="block text-sm font-medium text-foreground">
              Adjustment <span className="font-normal text-muted-foreground">(e.g. -1)</span>
            </label>
            <input
              id="adjust-delta"
              type="number"
